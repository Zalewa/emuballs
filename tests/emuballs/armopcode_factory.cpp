...
struct Fixture
{
	...
	struct CodeSet
	{
		Emuballs::Arm::OpFactory factory;
		std::list<Code> codes;
	};
	...
	Fixture()
	{
		codes.emplace(Factory::opcodeMultiply,
			CodeSet {
				Emuballs::Arm::opcodeMultiply, std::list<Code> {
		...
		codes.emplace(Factory::opcodeMultiplyLong,
			CodeSet {
				Emuballs::Arm::opcodeMultiplyLong, std::list<Code> {
		...
		codes.emplace(Factory::opcodeBranch,
			CodeSet {
				Emuballs::Arm::opcodeBranch, std::list<Code> {
					{0xeafffffe}, // b 8000
					{0xebfffffd}, // bl 8000
						}});
		codes.emplace(Factory::opcodeBranchAndExchange,
			CodeSet {
				Emuballs::Arm::opcodeBranchAndExchange, std::list<Code> {
					{0xe12fff10}, // bx r0
					{0xe12fff13}, // bx r3
					{0xe12fff1e}, // bx lr
						}});
		codes.emplace(Factory::opcodeSingleDataTransfer,
			CodeSet {
				Emuballs::Arm::opcodeSingleDataTransfer, std::list<Code> {
		...
		codes.emplace(Factory::opcodeDoublewordDataTransfer,
			CodeSet {
				Emuballs::Arm::opcodeDoublewordDataTransfer, std::list<Code> {
		...
		codes.emplace(Factory::opcodeBlockDataTransfer,
			CodeSet {
				Emuballs::Arm::opcodeBlockDataTransfer, std::list<Code> {
		...
		codes.emplace(Factory::opcodeSingleDataSwap,
			CodeSet {
				Emuballs::Arm::opcodeSingleDataSwap, std::list<Code> {
		...
		codes.emplace(Factory::opcodeSoftwareInterrupt,
			CodeSet {
				Emuballs::Arm::opcodeSoftwareInterrupt, std::list<Code> {
		...
		codes.emplace(Factory::opcodeDataProcessingPsrTransfer,
			CodeSet {
				Emuballs::Arm::opcodeDataProcessingPsrTransfer, std::list<Code> {
		...
		codes.emplace(Factory::opcodeCoprocessorDataTransfer,
			CodeSet {
				Emuballs::Arm::opcodeCoprocessorDataTransfer, std::list<Code> {
		...
		codes.emplace(Factory::opcodeCoprocessorDataOperation,
			CodeSet {
				Emuballs::Arm::opcodeCoprocessorDataOperation, std::list<Code> {
		...
		codes.emplace(Factory::opcodeCoprocessorRegisterTransfer,
			CodeSet {
				Emuballs::Arm::opcodeCoprocessorRegisterTransfer, std::list<Code> {
...
BOOST_AUTO_TEST_CASE(run)
{
	for (auto const &codebatch : codes)
	{
		...
		for (auto const &code : codebatch.second.codes)
		{
			...
			Emuballs::Arm::OpcodePtr opcode = factory(code.code);
